<template>
    ...
    <div class="p-0">
      <div class="row no-gutters">
        ...
        <img src="../assets/img/bg-showcase-1.jpg" alt="Smiley face" height="50%" width="50%"></div>
      ...
      <div class="row no-gutters">
        <div class="col-lg-6 order-lg-2 text-white showcase-img">
        <img src="../assets/img/bg-showcase-3.jpg" alt="Smiley face" height="50%" width="50%"></div>
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
          <h2>最短1営業日から納品可能</h2>
